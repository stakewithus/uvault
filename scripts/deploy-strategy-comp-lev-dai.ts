...
import config, { DAI, CDAI, TOKEN_TO_VAULT } from "./config"
...
/*
usage:
env $(cat .env) npx hardhat deploy:strategy-comp-lev-dai \
--network mainnet \
--dev true
*/
task("deploy:strategy-comp-lev-dai", `Deploy ${STRATEGY}`)
