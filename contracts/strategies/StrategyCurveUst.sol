...
import "../interfaces/curve/StableSwapUst.sol";
import "../interfaces/curve/StableSwap3Pool.sol";
import "../interfaces/curve/DepositUst.sol";

contract StrategyCurveUst is StrategyERC20_V3 {
    ...
    address internal constant UST = 0xa47c8bf37f92aBed4A126BDA807A7b7498661acD;
    address internal constant DAI = 0x6B175474E89094C44Da98b954EedeAC495271d0F;
    address internal constant USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    address internal constant USDT = 0xdAC17F958D2ee523a2206206994597C13D831ec7;

    // UST = 0 | DAI = 1 | USDC = 2 | USDT = 3
    ...
    // DepositUst
    address private constant DEPOSIT = 0xB0a0716841F2Fc03fbA72A891B8Bb13584F52F2d;
    // LiquidityGaugeV2
    address private constant GAUGE = 0x3B7020743Bc2A4ca9EaF9D0722d42E20d6935855;
    // Minter
    ...
    */
    ...
    constructor(
        ...
        // Approve DepositUst.add_liquidity
        IERC20(UST).safeApprove(DEPOSIT, type(uint).max);
        ...
        // approve DepositUst.remove_liquidity
    ...
    */
    ...
    function _totalAssets() private view returns (uint) {
        ...
        uint pricePerShare = StableSwapUst(SWAP).get_virtual_price();
    ...
    function _deposit(address _token, uint _index) private {
        ...
        if (bal > 0) {
            ...
            */
            ...
            uint lpAmount = DepositUst(DEPOSIT).add_liquidity(amounts, min);
    ...
    */
    function _withdraw(uint _amount) private returns (uint) {
        ...
        if (shares > 0) {
            ...
            return
                DepositUst(DEPOSIT).remove_liquidity_one_coin(
                    shares,
    ...
    */
    function _getMostPremiumToken() private view returns (address, uint) {
        ...
        balances[0] = StableSwapUst(SWAP).balances(0); // UST
        balances[1] = StableSwapUst(SWAP).balances(1); // 3CRV
