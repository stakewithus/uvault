...
contract StrategyYV2 is StrategyERC20 {
    // Uniswap //
    ...
    // DepositY
    address private constant DEPOSIT = 0xbBC81d23Ea2c3ec7e56D39296F0cbB648873a5d3;
    // LiquidityGauge
    ...
    function _depositIntoCurve(address _token, uint _index) private {
        ...
        if (bal > 0) {
            ...
            */
            ...
            DepositY(DEPOSIT).add_liquidity(amounts, min);
        }
    ...
    */
    ...
    function _withdraw(uint _lpAmount) internal override {
        ...
        */
        ...
        DepositY(DEPOSIT).remove_liquidity_one_coin(
            lpBal,
