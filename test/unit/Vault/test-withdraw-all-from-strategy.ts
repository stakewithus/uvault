  ...
  describe("withdrawAllFromStrategy", () => {
    ...
    describe("strategy is set", () => {
      ...
      it("should withdraw from strategy", async () => {
        ...
        await vault.withdrawAllFromStrategy(min, {from: admin})
      ...
      it("should reject if not authorized", async () => {
        ...
        await chai
          .expect(vault.withdrawAllFromStrategy(min, {from: accounts[1]}))
      ...
      it("should reject if returned amount < min", async () => {
        ...
        await chai
          .expect(vault.withdrawAllFromStrategy(min, {from: admin}))
