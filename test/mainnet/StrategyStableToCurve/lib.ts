...
import { StrategyDaiToCusdContract, StrategyDaiToCusdInstance } from "../../../types/StrategyDaiToCusd"
import { StrategyUsdcToCusdContract, StrategyUsdcToCusdInstance } from "../../../types/StrategyUsdcToCusd"
import { StrategyDaiTo3CrvContract, StrategyDaiTo3CrvInstance } from "../../../types/StrategyDaiTo3Crv"
import { StrategyUsdcTo3CrvContract, StrategyUsdcTo3CrvInstance } from "../../../types/StrategyUsdcTo3Crv"
import { StrategyUsdtTo3CrvContract, StrategyUsdtTo3CrvInstance } from "../../../types/StrategyUsdtTo3Crv"

export type StrategyContract = StrategyDaiToCusdContract
  | StrategyUsdcToCusdContract
  | StrategyDaiTo3CrvContract
  | StrategyUsdcTo3CrvContract
  | StrategyUsdtTo3CrvContract

export type StrategyInstance = StrategyUsdcToCusdInstance
...
export function getSnapshot(params: {
  strategy: StrategyInstance, underlying: Ierc20Instance, cUnderlying: Ierc20Instance, gauge: GaugeInstance, crv: Ierc20Instance,
  vault: string, treasury: string
}) {
