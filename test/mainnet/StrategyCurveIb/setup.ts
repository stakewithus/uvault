...
import { CRV, IB_LP, IB_GAUGE, STABLE_SWAP_IB } from "../config"
import { Refs, StrategyContract } from "./lib"

const IERC20 = artifacts.require("IERC20")
const StableSwapIb = artifacts.require("StableSwapIb")
...
export default (
  ...
  const LP = IB_LP
  const GAUGE = IB_GAUGE
  const STABLE_SWAP = STABLE_SWAP_IB
  ...
  beforeEach(async () => {
    ...
    refs.stableSwap = await StableSwapIb.at(STABLE_SWAP)
