import {
  IERC20Instance,
  StableSwapIbInstance,
  LiquidityGaugeV2Instance,
  ControllerInstance,
  StrategyCurveIbDaiContract,
  StrategyCurveIbDaiInstance,
  StrategyCurveIbUsdcContract,
  StrategyCurveIbUsdcInstance,
  StrategyCurveIbUsdtContract,
  StrategyCurveIbUsdtInstance,
} from "../../../types"
...
export interface Refs {
  ...
  lp: IERC20Instance
  stableSwap: StableSwapIbInstance
