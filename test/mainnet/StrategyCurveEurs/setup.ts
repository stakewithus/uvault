...
import { CRV, EURS_LP, EURS_GAUGE, STABLE_SWAP_EURS } from "../config"
import { Refs, StrategyContract } from "./lib"

const IERC20 = artifacts.require("IERC20")
const StableSwapEurs = artifacts.require("StableSwapEurs")
...
export default (
  ...
  const LP = EURS_LP
  const GAUGE = EURS_GAUGE
  const STABLE_SWAP = STABLE_SWAP_EURS
  ...
  beforeEach(async () => {
    ...
    refs.stableSwap = await StableSwapEurs.at(STABLE_SWAP)
