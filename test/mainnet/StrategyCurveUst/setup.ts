...
import { CRV, UST_LP, UST_GAUGE, STABLE_SWAP_UST } from "../config"
import { Refs, StrategyContract } from "./lib"

const IERC20 = artifacts.require("IERC20")
const StableSwapUst = artifacts.require("StableSwapUst")
...
export default (
  ...
  const LP = UST_LP
  const GAUGE = UST_GAUGE
  const STABLE_SWAP = STABLE_SWAP_UST
  ...
  beforeEach(async () => {
    ...
    refs.stableSwap = await StableSwapUst.at(STABLE_SWAP)
